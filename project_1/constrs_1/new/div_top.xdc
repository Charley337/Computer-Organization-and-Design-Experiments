...
set_property PACKAGE_PIN W9 [get_ports start_i]

set_property PACKAGE_PIN W4 [get_ports y[0]]
set_property PACKAGE_PIN R4 [get_ports y[1]]
set_property PACKAGE_PIN T4 [get_ports y[2]]
...
set_property PACKAGE_PIN W5 [get_ports y[6]]
set_property PACKAGE_PIN U6 [get_ports y[7]]

set_property PACKAGE_PIN V5 [get_ports x[0]]
set_property PACKAGE_PIN R6 [get_ports x[1]]
set_property PACKAGE_PIN T6 [get_ports x[2]]
set_property PACKAGE_PIN Y6 [get_ports x[3]]
set_property PACKAGE_PIN AA6 [get_ports x[4]]
set_property PACKAGE_PIN V7 [get_ports x[5]]
set_property PACKAGE_PIN AB7 [get_ports x[6]]
set_property PACKAGE_PIN AB6 [get_ports x[7]]
